...
public class CloseWind : MonoBehaviour {
    ...
    private void Awake()
    {
        //Поиск всех объектов с которыми будем играть в "покажи и скрой":::
        // камера с игрой
    ...
    public void pause()
    {
        //скрыть / показать Камеру игры и игровые объекты
        objHandler.objRefs["GAME"].SetActive(false);
        objHandler.objRefs["MainCamera"].SetActive(false);
        //скрыть / показать Камеру меню и объекты меню
